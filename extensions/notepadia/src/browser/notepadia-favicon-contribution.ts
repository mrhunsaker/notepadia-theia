...
const NOTEPADIA_ICON = `<svg xmlns="http://www.w3.org/2000/svg" width="1024" height="1024" viewBox="0 0 1024 1024">
  <defs>
    <linearGradient id="bg" x1="0" y1="0" x2="0" y2="1">
      <stop offset="0" stop-color="#FFBCDE"/>
      <stop offset="1" stop-color="#EA6FB0"/>
    </linearGradient>
    ...
    <linearGradient id="pencil" x1="0" y1="0" x2="1" y2="0">
      <stop offset="0" stop-color="#D6338F"/>
      <stop offset="1" stop-color="#8E0F52"/>
    </linearGradient>
    <filter id="shadow" x="-30%" y="-30%" width="160%" height="160%">
      <feDropShadow dx="0" dy="18" stdDeviation="22" flood-color="#7A1049" flood-opacity="0.35"/>
    </filter>
  </defs>

  <rect x="64" y="64" width="896" height="896" rx="208" fill="url(#bg)"/>
  <rect x="70" y="70" width="884" height="884" rx="202" fill="none" stroke="#FFFFFF" stroke-opacity="0.35" stroke-width="8"/>

  <g filter="url(#shadow)">
    <path d="M336 188 H628 L744 304 V756 Q744 790 710 790 H336 Q302 790 302 756 V222 Q302 188 336 188 Z" fill="url(#page)"/>
  </g>
  <path d="M628 188 V270 Q628 304 662 304 H744 Z" fill="#FFD3E8"/>
  <path d="M628 188 V270 Q628 304 662 304 H744" fill="none" stroke="#F0A7CB" stroke-width="7" stroke-linejoin="round"/>
  ...
  <g transform="translate(608,548) rotate(-135)" stroke="#7A1049" stroke-width="9" stroke-linejoin="round">
    <rect x="-50" y="-306" width="100" height="56" rx="20" fill="#FFC2E0"/>
    <rect x="-54" y="-248" width="108" height="48" rx="12" fill="#C2185B"/>
    <rect x="-46" y="-208" width="92" height="322" rx="18" fill="url(#pencil)"/>
    <rect x="-34" y="-198" width="24" height="300" rx="12" fill="#FFFFFF" fill-opacity="0.28" stroke="none"/>
    <path d="M-46 114 H46 L0 226 Z" fill="#F3CE9B"/>
    <path d="M-16 166 H16 L0 226 Z" fill="#4A4A4A" stroke="none"/>
  </g>
</svg>`;
